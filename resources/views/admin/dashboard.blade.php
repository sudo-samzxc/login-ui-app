<x-admin-master>
    ...
    @section('content')
        ...
        <div class="row">
            ...
            <x-admin.dashboard.earnings-overview />

            <x-admin.dashboard.revenue-sources />
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4">
                ...
                <x-admin.dashboard.projects />

                <x-admin.dashboard.color-system />

            </div>

            <div class="col-lg-6 mb-4">

                <x-admin.dashboard.illustrations />
    ...
    @section('page-js-bundle')
        @vite('resources/js/admin-dashboard-bundle.js')
    @endsection
